...
ActiveRecord::Schema.define(version: 20170512091006) do
  ...
  add_index "good_orders", ["good_id"], name: "index_good_orders_on_good_id", using: :btree
  add_index "good_orders", ["order_id"], name: "index_good_orders_on_order_id", using: :btree
  ...
  add_index "goods", ["article"], name: "index_goods_on_article", unique: true, using: :btree
  add_index "goods", ["title"], name: "index_goods_on_title", unique: true, using: :btree
  ...
  add_foreign_key "good_orders", "goods"
  add_foreign_key "good_orders", "orders"
